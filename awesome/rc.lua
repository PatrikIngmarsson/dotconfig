...
beautiful.init(awful.util.getdir("config") .. "themes/aztrixiania/theme.lua")
...
rseparator = wibox.widget.textbox(" | ")
weak_separator = wibox.widget.textbox(" ")
...
globalkeys = gears.table.join(
    ...
    awful.key({                   }, "F12", function () awful.spawn("i3lock") end,
              {description = "Lock screen", group = "awesome"}),
    awful.key({                   }, "Print", function () awful.spawn("scrot") end,
              {description = "Take screen shot", group = "awesome"}),
